                        ...
                        <li class="dropdown">
                            ...
                            <ul class="dropdown-menu" >
                                ...
                                <?php } else { ?>
                                    <li><a href="<?= base_url() ?>booking/historybooking">My Booking</a></li>   
                                <?php } ?>
                                <li><a href="<?php echo base_url() ?>users/edituser/<?= $this->session->userdata('id') ?>">Edit Profile</a></li>
...
// 				console.log(event.data);
        ...
        html = html + '<li class="mynotificationcss"><div class="list-group"><a href="http://cbt.backeyefinder.in.th/notification/seennoti/'+rs.link+'/'+rs.recive_id+'/'+rs.stadium_id+'">'+
