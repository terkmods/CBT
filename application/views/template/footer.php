...
$(document).ready(function(){
  ...
  $("#btn2").click(function(){
    $("#add").append('<div id="delja"><div class="col-lg-10 col-md-offset-2" ><div class="col-md-3" style="margin-top:10px ;padding: 0; "> <select class="form-control"><option>จันทร์</option>'+
