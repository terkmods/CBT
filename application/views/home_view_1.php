...
// 				console.log(event.data);
    ...
    <body>
        ...
        <?php if ($this->session->userdata('role') == "owner") { ?>
                                                        <li><a href="<?= base_url() ?>stadium">Dash board</a></li>
                                                        <li><a href="<?= base_url() ?>booking/historybooking">My Booking</a></li>
                                                        <li class="subdrop"><a href="<?= base_url() ?>stadium/managestadium">Manage Stadium</a></li>
                                                        <li class="divider"></li>
        ...
        <?php } else { ?>
                                                        <li><a href="<?= base_url() ?>booking/historybooking">My Booking</a></li>   
        <?php } ?>
                                                <li><a href="users/edituser/<?= $this->session->userdata('id') ?>">Edit Profile</a></li>
                                                    ...
                                                    <div class="panel panel-default">
                                                        <div class="row padall" id="clickme">
                                                            <div class="col-xs-12 col-sm-12 col-md-3 col-lg-3">
                                                                <span></span>
                                                                <a href="<?php echo base_url() ?>stadium/profile/<?= $st->stadium_id ?>" ><img class="img-responsive" src="<?php echo base_url() ?>asset/images/<?= $st->stadium_path != null ? 'stadiumpic/' . $st->stadium_path . '' : 'bad.png' ?>" /></a>
                                                            </div>
